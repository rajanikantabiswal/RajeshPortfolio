...
import { Download, ArrowRight, Video, Sparkles, Image as ImageIcon } from 'lucide-react';
import Button from '../components/Button';
import profileImg from '../assets/rajesh_profile.png';
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full z-10">
        ...
        >
          ...
          >
            Creative and detail-oriented Graphic Designer with <strong className="text-white">7+ years of experience</strong> in branding, social media creatives, print media, motion graphics, and video editing.
          </motion.p>
          ...
          >
            <div>
              <p className="font-display text-2xl md:text-3xl font-black text-white">7+</p>
              <p className="text-xs text-text-muted tracking-wider uppercase">Years Exp</p>
            </div>
            <div className="border-l border-white/10" />
            <div>
              <p className="font-display text-2xl md:text-3xl font-black text-white">500+</p>
              <p className="text-xs text-text-muted tracking-wider uppercase">Projects done</p>
            </div>
            <div className="border-l border-white/10" />
            <div>
              <p className="font-display text-2xl md:text-3xl font-black text-white">100%</p>
              <p className="text-xs text-text-muted tracking-wider uppercase">Happy Clients</p>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          <div className="relative w-72 h-72 sm:w-96 sm:h-96">
              ...
              <div className="w-full h-full rounded-2xl overflow-hidden bg-zinc-900 relative">
                ...
                <div className="absolute bottom-4 left-4 right-4 glass-card px-3 py-2 rounded-xl border border-white/10 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold text-white/90 uppercase tracking-widest">Available for Hire</span>
                  </div>
                  <span className="text-[9px] text-brand-cyan font-bold uppercase tracking-wider">Bhubaneswar, IN</span>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <span className="text-[10px] font-bold text-white uppercase tracking-wider leading-none">Video Editor</span>
            </motion.div>
            ...
            >
              ...
              <span className="text-[10px] font-bold text-white uppercase tracking-wider leading-none">Graphic Designer</span>
            </motion.div>
          </div>
        </motion.div>
