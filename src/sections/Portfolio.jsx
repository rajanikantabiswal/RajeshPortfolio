...
import imgSocial from "../assets/portfolio_social.webp";
  ...
  const projects = [
    {
      ...
      description:
        "A premium social media grid campaign featuring rich traditional gold jewelry. Modeled with high-contrast luxury photography and cybernetic background gradients to appeal to modern elite buyers.",
    },
    {
      id: 2,
      ...
      description:
        "A sleek, minimalist luxury gold logo emblem designed on a heavy matte paper surface, capturing innovation, technology, and engineering precision.",
    },
    {
      id: 3,
      ...
      description:
        "Sophisticated matte black packaging design embellished with premium gold leaf details and custom luxury floral graphics, optimized for high-end retail displays.",
    },
    {
      id: 4,
      ...
      description:
        "An adrenaline-fueled promotional motion poster sequence utilizing advanced tracking, 3D typography layers, and synchronized ambient bass beats.",
    },
    {
      id: 5,
      ...
      description:
        "Elegant dual-sided business card layout with custom metallic silver printing, featuring blind debossing on high-density black linen stock.",
    },
    {
      id: 6,
      ...
      client: "Arundhati Jewellers Pvt. Ltd.",
      description:
        "A 6x3 feet luxury showroom standee layout, featuring premium crop marks, sharp vector fonts, and high-fidelity product placement graphics.",
    },
    {
      id: 7,
      ...
      client: "Arundhati Jewellers Pvt. Ltd.",
      description:
        "Full-page regional newspaper advertisement layout, optimized with precise CMYK settings and rich ink density for premium newsprint media.",
    },
    {
      id: 8,
      ...
      description:
        "Large-scale vector outdoor hoarding canvas, specifically structured with extreme typographic readability guidelines for high-speed highway motorists.",
    },
    {
      id: 9,
      ...
      description:
        "Cinematic visual sequence featuring advanced color grading, sound design overlays, speed-ramping, and elegant custom text titles.",
    },
    {
      id: 10,
      ...
      client: "Arundhati Jewellers Pvt. Ltd.",
      description:
        "A double-sided visual circular dangler structure, displaying festival greetings, high-fidelity ornaments, and detailed corporate design branding.",
    },
    {
      id: 11,
      ...
      client: "Arundhati Jewellers Pvt. Ltd.",
      description:
        "Modern, clean employee identity card layout featuring QR codes, high-resolution portrait framing, and distinct corporate color codes.",
    },
    {
      id: 12,
      ...
      client: "EmerTech Solutions",
      description:
        "A multi-page square fold brochure showcasing high-end industrial tech components, featuring beautiful layouts and premium typography.",
    },
  ];
